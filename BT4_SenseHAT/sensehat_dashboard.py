...
# #hang 6 -7: trang thai
        ...
        print(
            f'Temp: {
                temp:.1f}C ({temp_cols} cols) | Hum: {
                hum:.1f}% ({hum_cols} cols)')
        time.sleep(1)
